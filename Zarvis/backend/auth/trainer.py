...
path = 'C:\\Users\\patna\\OneDrive\\Desktop\\Zarvis\\backend\\auth' # Path for samples already taken
...
recognizer.write('C:\\Users\\patna\\OneDrive\\Desktop\\Zarvis\\backend\\auth\\trainer\\trainer.yml')  # Save the trained model as trainer.yml
